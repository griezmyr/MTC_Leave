			...
			<div class="card-box pd-20 height-100-p mb-30">
				<div class="row align-items-center">
					...
					<div class="col-md-8">
						...
						<p class="font-18 max-width-600">MTC Engineering Sdn Bhd <br> No 2, Jalan Astaka U8/88 B, Bukit Jelutong, 40150 Shah Alam, Selangor.</p>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px">
						<div class="d-flex justify-content-between">
							<div class="h5 mb-0">View Leave Applications</div>

							<div class="table-actions">
								<a title="VIEW" href="leaves.php"><i class="icon-copy ion-disc" data-color="#17a2b8"></i></a>	
							</div>
						</div>	
